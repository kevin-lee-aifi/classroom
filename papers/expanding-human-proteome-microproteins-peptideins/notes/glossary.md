...
- **HLA typing** — the sample's HLA alleles. Retrieved at full four-digit resolution for 4,879 MS runs by manually searching each run's publication (Methods, annotating immunopeptidomics MS runs).
...
- **HUPO-HIPP** — the HUPO Human Immuno-Peptidome Project, the standards body for immunopeptidomics data (ref. 14, Caron *et al.*, *Immunity* **47**, 203–208, 2017). Its participation is why HLA evidence has its own column in the tier table.
